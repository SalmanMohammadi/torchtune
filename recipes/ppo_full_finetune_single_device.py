...
class PPOFullFinetuneRecipeSingleDevice(FTRecipeInterface):
    ...
    ) -> Tuple[utils.Checkpointer, utils.Checkpointer, utils.Checkpointer, utils.Checkpointer]:
        """
    ...
    def generate_trajectory(self, input_ids: torch.Tensor) -> Trajectory:
        ...
        masks = rlhf.get_causal_mask_from_padding_mask(query_response_padding_masks)
        ...
        position_ids = rlhf.get_position_ids_from_padding_mask(query_response_padding_masks)
